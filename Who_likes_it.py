...
def likes(names):
    ...
    if len(names) == 1: string = ("{} likes this".format(names[0]))
    if len(names) == 2: string = ("{} and {} like this".format(names[0], names[1]))
    if len(names) == 3: 
        string = ("{}, {} and {} like this".format(names[0], names[1],names[2]))
    if len(names) >= 4: 
        string = ("{}, {} and {} others like this".format(names[0], names[1], len(names)-2))
    return string
